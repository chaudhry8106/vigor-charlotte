...
var precacheConfig = [
        ["/index.html", "aefb8967bf0d9b8e0738f38db69e8b95"],
        ["/static/css/main.fa452354.css", "599fd1095194c2ea1bb937f20edfb9ba"],
        ["/static/js/main.97e95887.js", "abad501ae4dca255685aa2f564f9bab5"]
    ],
    cacheName = "sw-precache-v3-sw-precache-webpack-plugin-" + (self.registration ? self.registration.scope : ""),
    ignoreUrlParametersMatching = [/^utm_/],
    addDirectoryIndex = function(e, t) { var n = new URL(e); return "/" === n.pathname.slice(-1) && (n.pathname += t), n.toString() },
    cleanResponse = function(e) { if (!e.redirected) return Promise.resolve(e); return ("body" in e ? Promise.resolve(e.body) : e.blob()).then(function(t) { return new Response(t, { headers: e.headers, status: e.status, statusText: e.statusText }) }) },
