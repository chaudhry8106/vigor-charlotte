...
const Nav = () =>
  <nav className="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
    <h1 className="site-title"><a href="/"><em className="fa fa-rocket"></em> Vigor</a></h1>
    ...
    <Link to="/landing" className="logout-button"><em className="fa fa-power-off"></em> Signout</Link>
  </nav>;
